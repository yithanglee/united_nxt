    ...
    <div className='flex flex-col min-h-screen items-center justify-center'>
      <header className='px-4 lg:px-6 h-14 flex items-center w-full '>
        <Link className='flex items-center justify-center' href='#'>
          ...
          <span className='ml-2 text-2xl font-bold'>LibraryPro</span>
        </Link>
          ...
          <div className='container px-4 md:px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <Card>
                ...
                <CardContent>
                  'LibraryPro has transformed how we manage our community library. The data insights are invaluable!'
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
          ...
          <div className='container px-4 md:px-6'>
            <div className='flex flex-col items-center space-y-4 text-center'>
              <div className='space-y-2'>
                ...
                <p className='mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400'>
                  Join thousands of libraries already benefiting from LibraryPro.
                </p>
              </div>
              <div className='space-x-4'>
      ...
      <footer className='flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t'>
        <p className='text-xs text-gray-500 dark:text-gray-400'>© 2024 LibraryPro. All rights reserved.</p>
